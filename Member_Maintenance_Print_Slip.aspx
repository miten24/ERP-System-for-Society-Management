<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Member_Maintenance_Print_Slip.aspx.cs" Inherits="SocietyManagment.Member_Maintenance_Print_Slip" %>
        ...
        <div>
          ...
          <div class="container-fluid">
           <div class="row">
            ...
            <div class="row">
              <div class="col-sm-3" >
                <asp:Button ID="btnMPrint" runat="server" Text="Print" class="btn btn-block btn-info btn-lg" OnClick="btnMPrint_Click"/>
              </div>
            </div>
                <hr />
                <asp:Label ID="lblCheckPflag" runat="server" ForeColor="Red"></asp:Label>
