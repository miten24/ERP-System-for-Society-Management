<%@ Page Language="C#" AutoEventWireup="true" Codefile="Committee_Account_Amount.aspx.cs" Inherits="SocietyManagment.Committee_Account_Amount" %>
...
<head runat="server">
  ...
  <title>Committee| Society Account</title>
            ...
            <!-- Content -->
             <div class="content-wrapper">
              ...
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-6">
                    <h1>Society Account</h1>
                  </div>
                  <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                      <li class="breadcrumb-item"><a href="Committee_Panel.aspx">Home</a></li>
                      <li class="breadcrumb-item active">Society Account</li>
                    </ol>
                  </div>
                </div>
              </div><!-- /.container-fluid -->
