<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Committee_Maintenance_Status.aspx.cs" Inherits="SocietyManagment.Committee_Maintenance_Status" %>
          ...
          <div class="wrapper">
            ...
            <section class="content">
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <asp:Label ID="Label2" runat="server" Text="List of Members Who already paid Maintenance of selected month"></asp:Label>
                  </div>
                </div>
                <br />
                  <asp:GridView ID="GridView1" runat="server" class="table table-bordered table-hover" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT [BlockNo], [MemberName], [FilledDate], [amount], [CommitteeMName], [CoCode] FROM [SocietyMaintenance] WHERE (([Month] = @Month) AND ([SocietyCode] = @SocietyCode)) ORDER BY [BlockNo]">
                        <SelectParameters>
