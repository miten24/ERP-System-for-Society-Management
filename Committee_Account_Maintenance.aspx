<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Committee_Account_Maintenance.aspx.cs" Inherits="SocietyManagment.Committee_Account_Maintenance" %>
            ...
            <!-- Content -->
             <div class="content-wrapper">
              ...
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-6">
                    <h1>Society Account Maintenance</h1>
                  </div>
                  <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                      <li class="breadcrumb-item"><a href="Committee_Account_Amount.aspx">Society Account</a></li>
                      <li class="breadcrumb-item active">Society Account Maintenance</li>
                    </ol>
                  </div>
                </div>
              </div><!-- /.container-fluid -->
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-4 col-6" >
                    <asp:Button ID="btnADDM" runat="server" Text="Add Maintenance" class="btn btn-block btn-info btn-lg" OnClick="btnADDM_Click" />
                  </div>
                  <div class="col-lg-4 col-6" >
                    <asp:Button ID="btnSEEM" runat="server" Text="Maintenance Status" class="btn btn-block btn-info btn-lg" OnClick="btnSEEM_Click" />
                  </div>
                </div>
              </div>
           </section>
