<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_TotalCommittee.aspx.cs" Inherits="SocietyManagment.Admin_TotalCommittee" %>
            ...
            <!-- Content -->
             ...
             <section class="content-header">
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-6">
                    <h1>Registerd Committee Members</h1>
                  </div>
                  <div class="col-sm-6">
               ...
               <div class="container-fluid">
                  ...
                  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" class="table table-bordered table-hover">
                      ...
                      <Columns>
                          ...
                          <asp:BoundField DataField="CommitteeMName" HeaderText="CommitteeMName" SortExpression="CommitteeMName" />
                          ...
                          <asp:BoundField DataField="CRole" HeaderText="CRole" SortExpression="CRole" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT [SocietyCode], [SocietyName], [CommitteeMName], [CoCode], [BDate], [CRole], [PhoneNumber], [Email] FROM [CommitteeInfo]"></asp:SqlDataSource>
               </div>
              </section>
            </div>
