<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Committee_Profile.aspx.cs" Inherits="SocietyManagment.Committee_Profile" %>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <form id="form1" runat="server">
                  ...
                  <img class="profile-user-img img-fluid img-circle"
                    ...
                    <h3 class="profile-username text-center">
                      ...
                      <p class="text-muted text-center">
                        <asp:Label ID="lblCPCode" runat="server"></asp:Label>
                      </p>
                ...
                <table class="table">
                  <tbody>
                     <tr>
                      ...
                      <td>
                        <asp:Label ID="lblCPSCode" runat="server" ></asp:Label>
                      </td>
                    </tr>
                     <tr>
                      <td><b>Society Name</b> </td>
                      <td>
                        <asp:Label ID="lblCPSName" runat="server" ></asp:Label>
                      </td>
                    </tr>
                    <tr>
                      <td><b>Role</b> </td>
                      <td>
                        <asp:Label ID="lblCPRole" runat="server" ></asp:Label>
                      </td>
                    </tr>
                    <tr>                     
                      <td><b>Birth Date</b></td>
                      <td>
                        <asp:Label ID="lblCPDate" runat="server"></asp:Label>
                      </td>                      
                    </tr>
                    <tr>                      
                      <td><b>Phone No.</b></td>
                      <td>
                         <asp:Label ID="lblCPPhoneNo" runat="server"></asp:Label>
                      </td>                     
                    </tr>
                    <tr>                      
                      <td> <b>Email</b> </td>
      ...
      <asp:HyperLink ID="HyperLink1" runat="server" class="btn btn-primary btn-block" NavigateUrl="~/Committee_Edit_Profile.aspx" ForeColor="White"><b>Edit</b></asp:HyperLink>
