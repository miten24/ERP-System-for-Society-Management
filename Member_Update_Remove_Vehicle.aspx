<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Member_Update_Remove_Vehicle.aspx.cs" Inherits="SocietyManagment.Member_Update_Remove_Vehicle" %>
...
<head runat="server">
  ...
  <title>Member| Update or Remove Vehicle </title>
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                              <div class="card-header">
                                <h3 class="card-title">Update or Remove Vehicle Details</h3>
                              </div>
                              <form role="form">
                                <div class="card-body">
                                   <div class="form-group">
                                    <div class="row">
                                       <div class="col-md-12">
                                        <label>Your Registered Vehicles</label>
                                          <asp:DropDownList ID="dlCURRVNO" runat="server" class="form-control" AutoPostBack="True" OnSelectedIndexChanged="dlCURRVNO_SelectedIndexChanged"></asp:DropDownList>
                                       </div>
                                     </div>
                                    </div>
                                  <div class="form-group">
                                    <div class="row">
                                       <div class="col-md-6">
                                        <label>Select the Type of Vehicle</label>
                                         <asp:DropDownList ID="dlCURVType" runat="server" class="form-control">
                                      ...
                                      <div class="col-md-6">
                                          ...
                                          <asp:TextBox ID="txtCURVNumber"  runat="server" class="form-control" placeholder="Enter the Number of Vehicle" TextMode="SingleLine" required></asp:TextBox>
                                       </div>
                                     </div>
                                    </div>
                                  <div class="form-group">
                               ...
                               <div class="card-footer">
                                   <asp:Button ID="btnCPUpdate" runat="server" class="btn btn-primary" Text="Update" OnClick="btnCPUpdate_Click" />
                                 <asp:Button ID="ctnCPRemove" runat="server" class="btn btn-danger" Text="Remove" OnClick="ctnCPRemove_Click" />
                                   <asp:Label ID="lblCPUFlag" runat="server"  ForeColor="Red"></asp:Label>
                                </div>
                              </form>
                            </div>
                            <!-- /.card -->
