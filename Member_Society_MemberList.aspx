<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Member_Society_MemberList.aspx.cs" Inherits="SocietyManagment.Member_Society_MemberList" %>
...
<head runat="server">
  ...
  <title>Member| Society Member List</title>
            ...
            <!-- Content -->
             <div class="content-wrapper">
              ...
              <div class="container-fluid">
               ...
               <div class="container-fluid ">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" GridLines="None" class="table table-bordered table-hover" ForeColor="#333333">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="MBDate" HeaderText="Birth Date" SortExpression="MBDate" />
