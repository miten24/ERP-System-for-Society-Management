<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Member_Societyinfo.aspx.cs" Inherits="SocietyManagment.Member_Societyinfo" %>
...
<head runat="server">
  ...
  <title>Member| Society Info</title>
                      ...
                      <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                          <h3 class="profile-username text-center">
                            <asp:Label ID="lblMSISName" runat="server"></asp:Label>
                          </h3>
                           <p class="text-muted text-center">
                             <asp:Label ID="lblMSISCode" runat="server"></asp:Label>
                           </p>
                ...
                <table class="table">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <asp:Label ID="lblMSIBlocks" runat="server" ></asp:Label>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <asp:Label ID="lblMSIUDate" runat="server"></asp:Label>
                      </td>
                    ...
                    <tr>
                      ...
                      <td><b>Address</b></td>
                      <td>
                         <asp:Label ID="lblMSIAddress" runat="server"></asp:Label>
                      </td>
                    ...
                    <tr>
                      ...
                      <td> <b>City</b> </td>
                      <td>
                        <asp:Label ID="lblMSICity" runat="server"></asp:Label>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                     <asp:Label ID="lblMSIState" runat="server" ></asp:Label>
                      </td>
                    </tr>
