<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Committee_Panel.aspx.cs" Inherits="SocietyManagment.Committee_Panel" %>
        ...
        <div class="row">
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><asp:Label ID="lblTmember" runat="server" Text="X"></asp:Label></h3>
                <p>Total Members</p>
              </div>
              <div class="icon">
                <i class="ion ion-android-people "></i>
              </div>
              <asp:HyperLink class="small-box-footer" runat="server" NavigateUrl="~/Committee_Total_Member.aspx">More info<i class="fas fa-arrow-circle-right"></i></asp:HyperLink>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><asp:Label ID="lblRBlock" runat="server"></asp:Label></h3>
                <p>Total Remaining Block</p>
              </div>
              <div class="icon">
                <i class="ion ion-home"></i>
              </div>
              <asp:HyperLink class="small-box-footer" runat="server" NavigateUrl="#">More info<i class="fas fa-arrow-circle-right"></i></asp:HyperLink>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><asp:Label ID="lblNoOfVehicles" runat="server" Text="X"></asp:Label></h3>
                <p>No. Of Vehicles</p>
              </div>
              <div class="icon">
                <i class="ion ion-person-add"></i>
              </div>
              <asp:HyperLink class="small-box-footer" runat="server" NavigateUrl="~/Committee_Vehicles_Info.aspx">More info<i class="fas fa-arrow-circle-right"></i></asp:HyperLink>
            </div>
          </div>
        </div>
                 </div>
