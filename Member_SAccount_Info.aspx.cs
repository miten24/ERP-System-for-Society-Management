...
{
  public partial class Member_SAccount_Info : System.Web.UI.Page
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      lblTamount.Text = TotalAmount(Session["MSCode"].ToString()).ToString();
    }
    ...
    {
      Response.Redirect("Member_Income_History.aspx");
    }

    protected void btnExpenseH_Click(object sender, EventArgs e)
    {
      Response.Redirect("Member_Expenses_History.aspx");
    }
  }
}
