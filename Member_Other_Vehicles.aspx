<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Member_Other_Vehicles.aspx.cs" Inherits="SocietyManagment.Member_Other_Vehicles" %>
             ...
             <div class="content-wrapper">
              ...
              <div class="container-fluid">
               ...
               <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" class="table table-bordered table-hover" ForeColor="#333333" GridLines="None">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT [MName], [TypeOfVehicle], [VehicleNo], [ModelName] FROM [VehicleDetails] WHERE ([SocietyCode] = @SocietyCode) EXCEPT SELECT [MName], [TypeOfVehicle], [VehicleNo], [ModelName] FROM [VehicleDetails] WHERE ([SocietyCode] = @SocietyCode) and ([Username]=@username)">
                       <SelectParameters>
                           <asp:SessionParameter Name="SocietyCode" SessionField="MSCode" Type="String" />
                           <asp:SessionParameter Name="username" SessionField="MUsername" />
                       </SelectParameters>
                   </asp:SqlDataSource>
               </div>
        </section>
