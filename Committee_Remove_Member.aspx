<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Committee_Remove_Member.aspx.cs" Inherits="SocietyManagment.Committee_Remove_Member" %>
...
<head runat="server">
  ...
  <title>Committee| Remove Member</title>
                            ...
                            <div class="card card-primary">
                              ...
                              <form role="form">
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      <div class="col-md-6">
                                          ...
                                          <asp:DropDownList ID="dlCRMMName" runat="server" class="form-control" AutoPostBack="True" OnSelectedIndexChanged="dlCRMMName_SelectedIndexChanged" ></asp:DropDownList>
                                       </div>
                                       <div class="col-md-6">
                                        <label>Member Name</label>
                                         <asp:TextBox ID="txtCRMMUsername" runat="server" class="form-control" placeholder="Enter Member Username" TextMode="SingleLine" required></asp:TextBox>
                                       </div>
                                     </div>
                                    </div>
                                  <div class="form-group">
                                    <div class="row">
                                       <div class="col-md-12">
                                        <label>Password</label>
                                         <asp:TextBox ID="txtCRMPassword" runat="server" class="form-control" placeholder="Enter Admin Password" TextMode="Password" required></asp:TextBox>
                                       </div>
                                     </div>
                                    </div>
                               ...
                               <div class="card-footer">
                                   <asp:Button ID="btnCRMRemove" runat="server" class="btn btn-danger" Text="Remove" OnClick="btnCRMRemove_Click"  />
                                   <asp:Label ID="lblCRMflag" runat="server" ForeColor="Red"></asp:Label>
                                </div>
                              </form>
                            </div>
                            <!-- /.card -->
