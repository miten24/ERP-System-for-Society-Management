<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_TotalMember.aspx.cs" Inherits="SocietyManagment.Admin_TotalMember" %>
               ...
               <div class="container-fluid">
                  ...
                  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" class="table table-bordered table-hover">
                      ...
                      <Columns>
                          ...
                          <asp:BoundField DataField="MBDate" HeaderText="BDate" SortExpression="MBDate" />
                          <asp:BoundField DataField="MTotalmember" HeaderText="Total Family Member" SortExpression="MTotalmember" />
                          <asp:BoundField DataField="MPhone" HeaderText="Phone No." SortExpression="MPhone" />
                          <asp:BoundField DataField="MEmail" HeaderText="Email" SortExpression="MEmail" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT [SocietyCode], [SocietyName], [MName], [MBDate], [MTotalmember], [MPhone], [MEmail], [HouseType], [MBlock] FROM [MemberInfo]"></asp:SqlDataSource>
               </div>
              </section>
            </div>
