<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Member_SAccount_Info.aspx.cs" Inherits="SocietyManagment.Member_SAccount_Info" %>
...
<head runat="server">
  ...
  <title>Member| Society Account</title>
            ...
            <!-- Content -->
             <div class="content-wrapper">
              ...
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-6">
                    <h1>Society Account Info</h1>
                  </div>
                  <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                      <li class="breadcrumb-item"><a href="Member_Panel.aspx">Home</a></li>
                      <li class="breadcrumb-item active">Society Account Info</li>
                    </ol>
                  </div>
                </div>
              </div><!-- /.container-fluid -->
           ...
           <div class="row">
                  <div class="col-lg-4 col-6">
                    ...
                    <div class="small-box bg-info">
                      <div class="inner">
                        <h3><asp:Label ID="lblTamount" runat="server"></asp:Label></h3>
                        <p>Total Amount</p>
                      </div>
                      <div class="icon">
                ...
                <div class="row">
                  <div class="col-lg-4 col-6" >
                    <asp:Button ID="btnIncomeH" runat="server" Text="Income History" class="btn btn-block btn-info btn-lg" OnClick="btnIncomeH_Click" />
                  </div>
                  <div class="col-lg-4 col-6" >
                    <asp:Button ID="btnExpenseH" runat="server" Text="Expenses History" class="btn btn-block btn-info btn-lg" OnClick="btnExpenseH_Click" />
                  </div>
                </div>
