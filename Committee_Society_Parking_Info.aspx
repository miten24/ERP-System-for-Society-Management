<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Committee_Society_Parking_Info.aspx.cs" Inherits="SocietyManagment.Committee_Society_Parking_Info" %>
                              ...
                              <form role="form">
                                <div class="card-body">
                                   <div class="form-group">
                                    <div class="row">
                                       <div class="col-md-6">
                                        <label>How many No. of  4 Wheels can parked? </label>
                                        <asp:TextBox ID="txtCP4Wheel" runat="server" class="form-control" placeholder="Enter No. of 4-Wheels" TextMode="Number" required></asp:TextBox>
                                       </div>
                                       <div class="col-md-6">
                                          <label>How many No. of  2 Wheels can parked?</label>
                                          <asp:TextBox ID="txtCP2Wheel" runat="server" class="form-control" placeholder="Enter No. of 2-Wheels" TextMode="Number" required></asp:TextBox>
                                       </div>
                                     </div>
                                    </div>
                                </div>
                               ...
                               <div class="card-footer">
                                   <asp:Button ID="btnCPAdd" runat="server" class="btn btn-primary" Text="Update" OnClick="btnCPAdd_Click" />
                                   <asp:Label ID="lblCPFlag" runat="server" ForeColor="Red"></asp:Label>
                                </div>
                              </form>
                            </div>
                            <!-- /.card -->
